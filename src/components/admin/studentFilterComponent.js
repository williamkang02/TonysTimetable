...
/**
 * StudentFilterComponent - A component to filter students by campus and course.
 ...
 */
const StudentFilterComponent = ({ onFilterChange }) => {
    // State hooks
     ...
     * Sends campusId and courseId, or null if 'all' is selected.
     */
    const handleApply = () => {
        onFilterChange({
